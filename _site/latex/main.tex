...
``Parameter-Efficient Fine-Tuning of Protein Language Models Improves Prediction of Protein-Protein Interactions,'' 
 \textit{Machine Learning for Structural Biology Workshop at NeurIPS}
}
...
``TreeFix-TP: Phylogenetic Error Correction for Accurate Reconstruction of Viral Transmission Networks,'' 
 \textit{Pacific Symposium on Biocomputing (PSB)}
}
...
``Decoding the Functional Interactome of Non-Model Organisms with PHILHARMONIC,'' 
 \textit{bioRxiv}, posted 21 Oct 2024, 10.1101/2024.10.25.620267
}
...
\Entry Flatiron Postdoctoral Research Fellowship
\hfill
\DatestampY{2024} - \DatestampY{2026}
\Gap

\Entry National Science Foundation (NSF) Graduate Research Fellowship
\hfill
\DatestampY{2021} - \DatestampY{2024}
\Gap

\Entry First Place, MIT Intro to Deep Learning Final Project Competition
\hfill
\DatestampY{2020}
\Gap

\Entry New England Scholar, University of Connecticut
\hfill
\DatestampY{2017} -- \DatestampY{2019}
\Gap

\Entry Dean's List, College of Liberal Arts and Sciences, School of Engineering
\hfill
\DatestampY{2015} --
\DatestampY{2019}
\Gap

\Entry Academic Excellence Scholarship, University of Connecticut
\hfill
...
\Entry National Merit Scholarship Finalist
\hfill
\DatestampY{2014}
...
\Entry {MIT Undergraduate Research Opportunities Program (UROP) Advisor}
\hfill
\DatestampY{2021} -- \DatestampY{2024}
\Gap

\Entry {MIT Research Summer Institute (RSI) Advisor}
\hfill
\DatestampY{2022} -- \DatestampY{2023}
\Gap

\Entry {HackMIT Mentor}
\hfill
...
\Entry {International Society for Computational Biology (ISCB)}
\hfill
%\DatestampY{2018}
\Gap

\Entry {Institute of Electronics Engineers (IEEE)}
\hfill
%\DatestampY{2018}
\Gap
...
\Entry {Tau Beta Pi, Engineering Honor Society (TB$\Pi$)}
\hfill
%\DatestampY{2018}
\Gap

\Entry {Eta Kappa Nu (IEEE-HKN)}
\hfill
%\DatestampY{2018}
\Gap

%\BulletItem {Upsilon Pi Epsilon, Computer Science Honor Society (UPE)}
\Entry {Upsilon Pi Epsilon, Computer Science Honor Society (UPE)}
\hfill
