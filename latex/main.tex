...
\textit{Current Opinion in Structural Biology}, 2026.
}
...
\textit{Nature Communications}, 17(1199), 2026.
}
...
\Gap
\NumberedItem{[8]}
{{Catrina, Bepler, \textbf{Sledzieski+}, Singh+}, 
``Reverse Distillation: Consistently Scaling Protein Language Model Representations,'' 
\textit{International Conference on Learning Representations}, 2026.
}
...
\Gap
\NumberedItem{[6]}
{{\textbf{Sledzieski}, Versavel, Singh, Ocitti, Devkota, Kumar, Shpilker, Roger, Yang, Lewinski, Putnam, Berger, Klein-Seetharaman, Cowen}, 
...
\Gap
\NumberedItem{[4]}
{{Golkar, Kovalic*, Espejo Morales*, \textbf{Sledzieski*}, Li*, Sokolova, Krawezik, Bietti, Skok Gibbs, Klypa, Xiong, Lanusse, Parker, Cho, Cranmer, Hehir, McCabe, Meyer, Morel, Mukhopadhyay, Pettee, Qu, Shen, Fouhey, Sotoudeh, Mulligan, Cossio, Hanson, Jones, Troyanskaya, Ho}, 
``MIMIC: A Generative Multimodal Foundation Model for Biomolecules,'' 
\textit{arXiv}, 2026. 10.48550/arXiv.2604.24506.
}
...
\hfill
\DatestampYM{2025}{01}, \DatestampYM{2026}{01}
\Gap
...
\Entry
{\textbf{TT3D}}
\hfill https://cb.csail.mit.edu/cb/topsyturvy/
\BigGap
\Entry
{\textbf{Topsy-Turvy}}
\hfill https://cb.csail.mit.edu/cb/topsyturvy/
...
\Entry
{\textbf{MINT}}
\hfill https://github.com/VarunUllanat/mint
\BigGap
\Gap
\textit{Protein Structure}
\Gap
\Entry
{\textbf{Seq2Symm}}
\hfill https://github.com/microsoft/seq2symm/
\BigGap
\Entry
{\textbf{RocketSHP}}
\hfill https://github.com/samsledje/RocketSHP
\BigGap
...
%% MENTORING %%
%%%%%%%%%%%%%%%
% Harry Liu, Purdue PhD / Flatiron Intern, LangBoltz
% Darius Catrina, Duke Undergraduate, PLM Reverse Distillation
% Christian Bepler, Duke Undergraduate, PLM Reverse Distillation
% Faith Occiti, Tufts PhD, ReCIPE and TT3D+
% Weiwei Lou, Tufts PhD, TT3D+
